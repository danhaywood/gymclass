 ...
 *  under the License.
 */
package domainapp.modules.employees.integtests;
...
import domainapp.modules.employees.EmployeesModuleManifest;

public abstract class EmployeesModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static void initSystem() {
        ...
        if(isft == null) {
            isft = new IsisSystemForTest.Builder()
                    ...
                    .with(new EmployeesModuleManifest() {
                        @Override
    ...
    public static class ModuleFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
        ...
        public FixtureScriptsSpecification getSpecification() {
            return FixtureScriptsSpecification.builder("domainapp.modules.employees").with(
