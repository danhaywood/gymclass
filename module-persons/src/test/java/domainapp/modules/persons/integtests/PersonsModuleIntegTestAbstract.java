...
import domainapp.modules.persons.PersonsModuleManifest;

public abstract class PersonsModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static void initSystem() {
        ...
        if(isft == null) {
            isft = new IsisSystemForTest.Builder()
                    ...
                    .with(new PersonsModuleManifest() {
                        @Override
    ...
    public static class ModuleFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
        ...
        public FixtureScriptsSpecification getSpecification() {
            return FixtureScriptsSpecification.builder("domainapp.modules.timetable").with(
