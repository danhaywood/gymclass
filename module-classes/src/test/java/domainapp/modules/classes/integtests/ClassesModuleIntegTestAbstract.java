...
import domainapp.modules.classes.ClassesModuleManifest;

public abstract class ClassesModuleIntegTestAbstract extends IntegrationTestAbstract {
    ...
    public static void initSystem() {
        ...
        if(isft == null) {
            isft = new IsisSystemForTest.Builder()
                    ...
                    .with(new ClassesModuleManifest() {
                        @Override
